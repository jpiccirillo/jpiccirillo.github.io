        ...
        function exports(_selection) {
            _selection.each(function (nestedData) {
                ...
                var years = d3.range(startYear, endYear).reverse(),
                    sizeByYear = height / (years.length + 2),
                ...
                var rect = year.selectAll('.day')
                    ...
                    //                                            return d.FIELD14 == null ? "none" : null;
                    //                                        })
                    .enter().append('rect')
                    .attr({
                        class: 'day',
                ...
                //                window.console.log(nestedData.FIELD1)
                ...
                rect.filter(function (d) {
                        //                        console.log(d);
                        return ((d in nestedData) ? (nestedData[d] > 1) : null);
                    })
                    .style('fill', function (d) {
                        //                        console.log("d: " + nestedData[d]);
