...
Showdown.converter = function () {
    ...
    var e = function (c) {
        ...
        h = function (a) {
            a = o(a);
            var b = t("<hr />");
            return a = a.replace(/^[ ]{0,2}([ ]?\*[ ]?){3,}[ \t]*$/gm, b), a = a.replace(/^[ ]{0,2}([ ]?\-[ ]?){3,}[ \t]*$/gm, b), a = a.replace(/^[ ]{0,2}([ ]?\_[ ]?){3,}[ \t]*$/gm, b), a = q(a), a = r(a), a = x(a), a = f(a), a = y(a), a
        },
        i = function (a) {
        ...
        l = function (c, d, e, f, g, h, i, j) {
            ...
            if (n == "") {
                ...
                if (a[m] != undefined) n = a[m], b[m] != undefined && (o = b[m]);
                else if (k.search(/\(\s*\)$/m) > -1) n = "";
                else return k
            }
            n = G(n, "*_");
            var p = '<a href="' + n + '"';
